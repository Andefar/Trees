...
2. RUN THE CODE
You only have to run the "TreeScript.fsx" file (no build needed)
First steps to run the "TreeScript.fsx" file
	...
	- RUN THE HOLE "TreeScript.fsx" file

A "example.gc" file has been used to create "example.ps" in working directory, take a look.
